        ...
        <header className="relative z-10 px-6 py-5">
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-cyan-400 bg-cyan-500/10 rounded-full border border-cyan-500/20">
                Demo
              </span>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative">
                <div className="absolute inset-0 scale-150 bg-gradient-radial from-cyan-500/20 via-transparent to-transparent blur-2xl" />
                <CallButton
                  status={status}
