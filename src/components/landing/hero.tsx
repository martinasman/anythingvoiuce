    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <Container className="relative z-10 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-[#1D1C1B] mb-6">
            Never Miss Another{' '}
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="relative">
            {/* Shadow */}
            <div className="absolute inset-0 bg-gradient-to-b from-[#1D1C1B]/10 to-[#1D1C1B]/5 rounded-sm blur-2xl transform translate-y-4" />

            {/* Mock Window */}
            <div className="relative bg-white rounded-sm border border-[#ECECEC] shadow-2xl overflow-hidden">
              {/* Window Chrome */}
              <div className="flex items-center gap-2 px-4 py-3 bg-[#F4F3F3] border-b border-[#ECECEC]">
                <div className="w-3 h-3 rounded-full bg-rose-400" />
                <div className="w-3 h-3 rounded-full bg-amber-400" />
                <div className="w-3 h-3 rounded-full bg-emerald-400" />
                <div className="ml-4 flex-1 text-center text-sm text-[#8A8A8A]">
                  AnythingVoice Demo
                </div>
              </div>
              ...
              <div className="p-8 bg-gradient-to-br from-slate-50 to-white min-h-[300px] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[#4A4A4A] mb-2">Your AI Receptionist is ready</p>
                  <p className="text-2xl font-display text-[#1D1C1B]">Click to start a demo call</p>
                </div>
              </div>
            </div>
          </div>
